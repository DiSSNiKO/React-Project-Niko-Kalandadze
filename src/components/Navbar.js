    ...
    render() {
        return <header>
            ...
            <div className="cart-currency-func">
                ...
                <CartOverlay increaseTotalPriceOfCartItems={this.props.increaseTotalPriceOfCartItems} decreaseTotalPriceOfCartItems={this.props.decreaseTotalPriceOfCartItems} 
